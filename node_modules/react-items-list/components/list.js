...
listClass = react.createClass({
  ...
  addItem() {
    ...
    this.setState({
      items: items.concat({value: this.state.lastItemValue, dirty: false}),
      lastItemValue: ""
  ...
  render() {
    ...
    return react.createElement(themeProvider, {muiTheme: getMuiTheme()},
